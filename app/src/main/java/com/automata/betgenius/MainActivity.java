...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseMessaging.getInstance().subscribeToTopic("genius");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            ...
            String shareBody = "I've been winning big with this Bet Genius app. Download here https://play.google.com/store/apps/details?id=com.automata.betgenius";
            sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Bet Genius App");
